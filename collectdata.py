...
url = 'http://192.168.29.24:8080/video'
...
while True:
    ...
    # Display the frame and other processing
    row = frame.shape[1]
    col = frame.shape[0]
    cv2.rectangle(frame, (0, 40), (450, 600), (255, 255, 255), 2)
    cv2.imshow("data", frame)
    cv2.imshow("ROI", frame[40:600, 0:450])
    frame = frame[40:600, 0:450]
